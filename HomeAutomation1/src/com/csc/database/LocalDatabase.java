...
public class LocalDatabase {
	...
	public static String KEY_HOME = "hid";
	
	private static final String DATABASE_NAME = "home_automation";
	private static final String DATABASE_TABLE = "appliance";
	private static final int DATABASE_VERSION = 1;
	
	public static final String[] ALL_KEYS = new String[] {KEY_APP_ID, KEY_APP_NAME, KEY_STATUS, KEY_HOME};
	...
	private static class DbHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			KEY_APP_ID + " VARCHAR(20) PRIMARY KEY, " + 
			KEY_APP_NAME + " TEXT NOT NULL, " +
			KEY_STATUS + " TEXT NOT NULL, " +
			KEY_HOME + " TEXT NOT NULL);");
	...
	public long createEntry(String id,String name,String status,String hid) {
		// TODO Auto-generated method stub
	...
	public ArrayList<Appliance> getdata(String value){
		// TODO Auto-generated method stub
		String[] columns = new String[]{ KEY_APP_ID, KEY_APP_NAME, KEY_STATUS, KEY_HOME};
		
		Cursor c = ourDatabase.query(DATABASE_TABLE, columns, KEY_HOME + "=?", new String[] {value}, null, null, null);
		...
		int ihid = c.getColumnIndex(KEY_HOME);
